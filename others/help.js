...
module.exports = {
  ...
  execute(message,args,client) {
    ...
    let helpEmbed = new MessageEmbed()
      ...
      .setAuthor('Click here to invite me!!', 'https://cdn.discordapp.com/attachments/549903089969135627/922118403119005756/1637659979709.jpg', 'https://discord.com/api/oauth2/authorize?client_id=921796461484736543&permissions=49572160&scope=bot')
      .setDescription(`**PREFIX:** \`${PREFIX}\``)
      .setFooter( client.user.username +`Type: ${PREFIX}help <Command>  for more information!`, "https://cdn.discordapp.com/attachments/549903089969135627/922118403119005756/1637659979709.jpg")
      .setColor("#F0EAD6");
